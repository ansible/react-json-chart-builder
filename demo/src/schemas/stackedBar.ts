  ...
  series: [
    {
      ...
      hidden: false,
      name: '0501aebd-f840-46b5-99fb-58a0bf3e8bf0'
    }
  ],
  legend: []
};
...
const description =
  'The stacked bar chart example shows how to use multiple \
...
export default {
  ...
  description,
  tags: [Tag.stacked, Tag.standaloneTooltip, Tag.styled, Tag.onClick],
  schema,
  data
};
